...
const placeholderImage = "data:image/svg+xml;base64,";
...
const ProductCard = ({ product, index }) => {
  ...
  const displayPrice = useMemo(
    () =>
      displayVariant
        ? formatFromUsdCents(hasSale ? displayVariant.sale_price_in_cents : displayVariant.price_in_cents)
        : null,
    [displayVariant, hasSale, formatFromUsdCents],
  );
  const originalPrice = useMemo(
    () => (hasSale ? formatFromUsdCents(displayVariant.price_in_cents) : null),
    [displayVariant, hasSale, formatFromUsdCents],
  );

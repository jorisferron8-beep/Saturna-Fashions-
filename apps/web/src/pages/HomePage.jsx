            ...
            <div className="fixed inset-x-0 top-0 z-50 border-b border-black/5 bg-[#F7F5F0]">
                ...
                <header className={`mx-auto flex max-w-[1440px] items-center justify-between gap-4 px-5 py-3.5 transition-shadow md:px-8 ${scrolled ? 'shadow-[0_1px_0_rgba(0,0,0,0.06)]' : ''}`}>
                    <div className="flex min-w-0 items-center gap-3">
                        <button type="button" className="text-black md:hidden" onClick={() => setOpen(true)} aria-label="Menú">
                    ...
                    <div className="flex items-center gap-3 text-[10px] font-medium uppercase tracking-[0.18em] text-black/70 md:gap-4">
                        ...
                        <button type="button" onClick={onOpenCart} className="relative transition-colors hover:text-black" aria-label="Bolsa">
...
function Hero() {
  ...
  return <section className="relative mt-[88px] min-h-[min(92dvh,900px)] w-full overflow-hidden bg-[#F7F5F0]">
            <motion.img src={IMG.hero} alt="SATURNA — Moda oscura femenina" className="absolute inset-0 h-full w-full object-cover object-[center_20%]" initial={reduce ? {} : {
      scale: 1.04
    }} animate={reduce ? {} : {
      scale: 1
    }} transition={{
      ...
      ease: [0.22, 1, 0.36, 1]
            ...
            <div className="relative z-10 mx-auto flex min-h-[min(92dvh,900px)] max-w-[1440px] flex-col justify-end px-5 pb-16 pt-28 md:px-8 md:pb-24">
                ...
                <h1 className="max-w-3xl font-display text-5xl font-semibold uppercase leading-[0.92] tracking-[0.04em] text-white md:text-7xl lg:text-8xl">
                    Moda Oscura Femenina
                </h1>
                <p className="mt-4 text-sm tracking-[0.28em] text-white/80 md:text-base">
                    Estética · Poder · Libertad
                </p>
                <p className="mt-6 max-w-md text-sm leading-relaxed text-white/80 md:text-base">
                    Vestidos, bodysuits, sastrería y seda — diseñados para mujeres que convierten la
                    noche en territorio propio.
                </p>
...
function mapLiveProduct(p, i, categoryMap) {
  ...
  return {
    ...
    subtitle: p.subtitle || (p.description?.slice(0, 48)) || 'Colección SATURNA',
    priceUsdCents: cents,
    image: img,
    hover: img,
            ...
            <div className="mx-auto max-w-[1440px]">
                <div className="mb-12 flex flex-col gap-2 md:mb-16 md:flex-row md:items-end md:justify-between">
                    ...
                    <p className="max-w-sm text-sm leading-relaxed text-neutral-500">
                        结构化轮廓。暗黑女性气质。为 18–25 岁 SATURNA 女性打造的单品。 Structured silhouettes for the modern SATURNA woman.
                    </p>
                </div>
                ...
                {loading ? <div className="flex justify-center py-24">
                        ...
                        <p className="font-display text-xl font-semibold uppercase tracking-[0.08em] text-black">Catálogo vacío</p>
                        <p className="mt-3 max-w-sm text-sm font-light leading-relaxed text-neutral-500">El catálogo de la boutique no devuelve productos en este momento. Vuelva a intentarlo más tarde.</p>
...
function Collections() {
  return <section id="collections" className="scroll-mt-28 border-t border-black/5 bg-white px-5 py-20 md:px-8 md:py-28">
            <div className="mx-auto max-w-[1440px]">
                ...
                <p className="mb-14 text-[11px] uppercase tracking-[0.28em] text-neutral-500">SATURNA / 成衣 · 18–25</p>

                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {COLLECTIONS.map(c => <a key={c.en} href={c.href} className="group block">
                            <div className="relative aspect-[4/5] overflow-hidden bg-neutral-100">
                                <img src={c.img} alt={c.cn} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-[1.04]" loading="lazy" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/10 to-transparent" />
                                <div className="absolute inset-x-0 bottom-0 p-6 text-white">
                                    <p className="text-[10px] uppercase tracking-[0.24em] text-white/70">{c.en}</p>
  ...
  return <section id="limited" className="scroll-mt-28 bg-[#0A0A0A] px-5 py-24 md:px-8 md:py-32">
            <div className="mx-auto grid max-w-[1440px] items-center gap-12 lg:grid-cols-2 lg:gap-16">
                <div className="relative aspect-[4/5] overflow-hidden md:aspect-[3/4]">
                    <img src={IMG.coat} alt="SATURNA Edición Limitada" className="h-full w-full object-cover" />
                ...
                <div className="text-white">
                    ...
                    <p className="mt-4 text-sm tracking-[0.2em] text-white/50">Pocas piezas · Una identidad</p>
                    <p className="mt-8 max-w-md text-sm leading-relaxed text-white/70">
                        Una selección de creaciones producidas en cantidad limitada — abrigos
                        escultóricos, encaje y siluetas de noche. Cada pieza, un universo propio.
                    </p>
...
function SaturnaWoman() {
  return <section id="woman" className="scroll-mt-28 bg-[#F7F5F0]">
            <div className="relative min-h-[70vh] w-full overflow-hidden md:min-h-[85vh]">
                <img src={IMG.blouse} alt="La Mujer SATURNA" className="absolute inset-0 h-full w-full object-cover object-center" />
...
function Atelier() {
  return <section id="atelier" className="border-t border-black/5 bg-white px-5 py-20 md:px-8 md:py-28">
            <div className="mx-auto grid max-w-[1440px] items-center gap-12 lg:grid-cols-2 lg:gap-16">
                ...
                <div>
                    <p className="text-[11px] uppercase tracking-[0.35em] text-[#5A1825]">El Atelier</p>
                    ...
                    <p className="mt-8 max-w-md text-sm leading-relaxed text-neutral-600">
                        Cada pieza SATURNA se desarrolla entre el estudio creativo y la clienta
                        privada: prototipos, pruebas y ajustes hasta que la silueta se siente como
                        una segunda piel.
                    </p>
                    <p className="mt-4 max-w-md text-sm leading-relaxed text-neutral-400">
                        Sin relleno. Sin accesorios de relleno. Solo silueta, tela y la mujer que
                        habita debajo.
                    </p>
  ...
  return <section id="cita" className="scroll-mt-28 bg-white px-5 py-20 md:px-8 md:py-28">
            <div className="mx-auto max-w-4xl text-center">
                ...
                <p className="mx-auto mt-8 max-w-lg text-sm leading-relaxed text-neutral-600">
                    Las pruebas privadas son sin prisa. Escriba a SATURNA y le guiaremos en un encargo
                    o en la selección de la categoría privada cliente.
                </p>
...
function Newsletter() {
  ...
  return <section id="newsletter" className="bg-[#F7F5F0] px-5 py-20 md:px-8 md:py-28">
            <div className="mx-auto max-w-3xl text-center">
                <p className="text-[11px] uppercase tracking-[0.5em] text-[#5A1825]">Boletín</p>
                ...
                <p className="mx-auto mt-6 max-w-md text-sm leading-relaxed text-neutral-600">
                    Accesos anticipados a colecciones, citas privadas y la apertura de la boutique en
                    línea. Sin ruido — solo dark fashion.
                </p>
                {sent ? <p className="mx-auto mt-10 max-w-md border border-black/15 bg-white px-6 py-5 font-display text-xl font-semibold uppercase tracking-tight text-black">
                        ...
                        <input type="email" required value={email} onChange={e => setEmail(e.target.value)} placeholder="Su correo electrónico" className="flex-1 border border-black/15 bg-white px-5 py-4 text-sm font-light text-black placeholder:text-neutral-400 focus:border-black focus:outline-none" />
                ...
                <p className="mt-5 text-[10px] uppercase tracking-[0.25em] text-neutral-400">
                    Al suscribirse acepta la Política de Privacidad. Sin spam.
                </p>
            </div>
        </section>;
}
            ...
            <div className="mx-auto max-w-[1440px] px-5 py-16 md:px-8">
                <div className="grid gap-12 md:grid-cols-4">
                    <div className="md:col-span-1">
                        ...
                        <p className="mt-4 max-w-xs text-sm leading-relaxed text-smoke">
                            Dark fashion femenina. USA · Colombia · Hong Kong / China. Solo prendas de
                            vestir.
                        </p>
                        <div className="mt-4">
                            <CurrencySelector />
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm font-light text-smoke">
                            <li><Link to="/store" className="hover:text-paper">Boutique en Línea</Link></li>
                            ...
                            <li><Link to="/cn" className="hover:text-paper">🇨🇳 中国 / HK</Link></li>
                            <li><a href="#new" className="hover:text-paper">Novedades</a></li>
                            <li><a href="#limited" className="hover:text-paper">Edición Limitada</a></li>
                        </ul>
                    </div>
                    <div>
                        <p className="mb-3 text-[10px] font-semibold uppercase tracking-[0.3em] text-violet-bright">
                ...
                <div className="mt-12 border-t border-border pt-8">
                    <p className="text-center text-[11px] font-light leading-relaxed text-smoke md:text-left">
                        © 2026 Swu-vision CORPORATION. Todos los derechos reservados. SATURNA™ Dark
                        Fashion. Contacto legales para reclamaciones:{' '}
...
export default function HomePage() {
  ...
  return <div className="min-h-screen bg-[#F7F5F0] font-body text-black antialiased">
            <Helmet>
                ...
                <meta name="description" content="SATURNA dark fashion femenina. Vestidos, bodysuits, sastrería y seda. Boutique en línea USA, Colombia, Hong Kong y China. Cliente privado y público." />
                <link rel="icon" type="image/png" href={SATURNA_LOGO} />
            </Helmet>
            <Seo title="SATURNA — Dark Fashion" description="SATURNA dark fashion femenina. Vestidos, bodysuits, sastrería y seda. Boutique USA, Colombia, Hong Kong y China." image={SATURNA_OG_IMAGE} siteName="SATURNA" />
